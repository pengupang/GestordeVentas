            ...
            content += `
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{% url 'inventario_editar' ${producto.id} %}" class='btn btn-warning'>
                            <i class="bi bi-pencil"></i>
                        </a>
                        <!-- Botón para deshabilitar, redirige a la vista de deshabilitación con confirmación -->
                        <a href="{% url 'deshabilitar_producto' ${producto.id} %}" class='btn btn-danger' onclick="return confirm('¿Estás seguro de deshabilitar este producto?');">
